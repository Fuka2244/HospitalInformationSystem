...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'doctor-workstation', name: 'DoctorWorkstation', component: () => import('@/views/staff/DoctorWorkstation.vue'), meta: { title: '医生工作台' } },
      { path: 'pharmacist-workstation', name: 'PharmacistWorkstation', component: () => import('@/views/staff/PharmacistWorkstation.vue'), meta: { title: '药师工作台' } },
      { path: 'admin-console', name: 'AdminConsole', component: () => import('@/views/staff/AdminConsole.vue'), meta: { title: '管理员控制台' } },
